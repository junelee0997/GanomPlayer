...
class ManyToOne(nn.Module): # 
    def __init__(self, encoder, output, hidden_size, seq_len = 10):
        ...
        self.rot_sig = nn.Sigmoid(device=encoder.device)
        ...
        self.vel_sig = nn.Sigmoid(device=encoder.device)
        ...
        self.snk = nn.Sigmoid(device=encoder.device)
        ...
        self.spt = nn.Sigmoid(device=encoder.device)
        ...
        self.atk = nn.Sigmoid(device=encoder.device)
